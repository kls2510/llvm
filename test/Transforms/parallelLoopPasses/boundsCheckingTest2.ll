...
entry:
  ...
  call void @llvm.lifetime.start(i64 2004, i8* %0) #3
  br label %for.body

for.body:                                         ; preds = %for.body, %entry
  %indvars.iv = phi i64 [ 0, %entry ], [ %indvars.iv.next, %for.body ]
  %arrayidx = getelementptr inbounds [501 x i32], [501 x i32]* %a, i64 0, i64 %indvars.iv
...
for.end:                                          ; preds = %for.body
  %arraydecay = getelementptr inbounds [501 x i32], [501 x i32]* %a, i64 0, i64 0
  %call = call i32 @test2(i32* %arraydecay)
  %2 = load i32, i32* %arraydecay, align 16, !tbaa !1
  call void @llvm.lifetime.end(i64 2004, i8* nonnull %0) #3
  ret i32 %2
}
